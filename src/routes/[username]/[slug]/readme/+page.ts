...
\`\`\`\n\n`);
	...
	for (const [category, plugins] of Object.entries(pluginByCategory).sort(([categoryA], [categoryB]) => categoryA > categoryB ? 1 : -1)) {
  ...
  const outro = `\n\n This readme was generated by [Dotfyle](https://dotfyle.com)`
	...
	readme = readme
		...
		.concat(languageServerSection).concat(outro)
