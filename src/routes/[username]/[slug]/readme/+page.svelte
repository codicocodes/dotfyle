<script lang="ts">
  ...
  let badgesHtml =
    $derived(`<a href="https://dotfyle.com/${data.config.owner}/${data.config.slug}"><img src="https://dotfyle.com/${data.config.owner}/${data.config.slug}/badges/plugins?style=${style}" /></a>
