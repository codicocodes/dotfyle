...
<a
	href={link}
	class="h-full flex flex-col justify-between rounded-md bg-white/10 transition-colors shadow-lg p-2 px-5 border-[0.5px] border-base-500 hover:border-base-200"
>
